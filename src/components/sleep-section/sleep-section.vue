    ...
    <div class="sleep container" id="sleep">
        ...
        <vue-slick-carousel>
            ...
            <travel-sleep-slider-item
                    ...
                    :rightImage="local.images.hammock"

                    getSliderName="sleep"
                    :getIndexBtn="index"

                    btnText="Book - Stay"
                    :rightBottomImage="local.images.flower"
...
export default {
  ...
  data () {
    return {
      local: {
        images: {
          flower: require('@/assets/img/sleep-section/flower.svg'),
          hammock: require('@/assets/img/sleep-section/hammock.svg')
        }
      }
    }
  },
