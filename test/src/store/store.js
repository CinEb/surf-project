export default {
    state: {
        ...
        icons:{
            search:'assets/img/local/Search.svg',
            poi: 'assets/img/local/POI.svg',
        },
        arrows:{
            arrowRight: 'assets/img/local/arrow-right.svg',
            arrowLeft: 'assets/img/local/arrow-left.svg',
            doubleArrowDown: 'assets/img/local/arrow-down.svg'
        },
        stars: 'assets/img/local/star.svg',
        window:{
            isDesktop: true,
